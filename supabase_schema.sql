...
('-576', 'STG-01', 'خطأ اتصال - تعذّر التواصل مع العداد', 'Connection Error - Failed to Communicate', 'فشل التواصل المادي مع العداد عبر المنفذ.', ARRAY['افحص الكابل الرابط بين الجهاز والعداد.', 'تأكد من أن المنفذ COM مضبوط بشكل صحيح.', 'أعد تشغيل برنامج الاختبار.', 'جرّب كابلاً آخر إذا لم يُجدِ الحل.']),
