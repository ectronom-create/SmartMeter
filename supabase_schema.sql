...
('-101', 'STG-01', 'خطأ SFC - فشل استرداد البيانات', 'فشل استرداد بيانات التصنيع من نظام SFC.', ARRAY['تحقق من اتصال الشبكة بالسيرفر.', 'أعد مسح الباركود مرة أخرى.', 'تأكد أن السيريال نمبر مسجّل في نظام SAP.', 'إذا استمر الخطأ، أبلغ مشرف تقنية المعلومات.']),
('-576', 'STG-01', 'خطأ اتصال - تعذّر التواصل مع العداد', 'فشل التواصل المادي مع العداد عبر المنفذ.', ARRAY['افحص الكابل الرابط بين الجهاز والعداد.', 'تأكد من أن المنفذ COM مضبوط بشكل صحيح.', 'أعد تشغيل برنامج الاختبار.', 'جرّب كابلاً آخر إذا لم يُجدِ الحل.']),
('ASM-01', 'STG-01', 'خطأ في تركيب الهيكل', 'عدم انتظام في تثبيت الهيكل الخارجي.', ARRAY['تحقق من محاذاة اللوحة الرئيسية.', 'تأكد من إحكام جميع البراغي بعزم الدوران المحدد.', 'افحص وجود تشوه أو كسر في الهيكل.']),
('E201', 'STG-02', 'تسريب تيار كهربائي', 'تجاوز قيمة تيار التسريب للحد المسموح به.', ARRAY['تأكد من جفاف العداد الكامل قبل الاختبار.', 'افحص العوازل البلاستيكية بحثاً عن شقوق أو تشويه.', 'نظّف نقاط التلامس من الرطوبة أو الأوساخ.', 'إذا فشل الاختبار مرتين متتاليتين، صنّف العداد كمعطوب.']),
('E202', 'STG-02', 'فشل اختبار Hi-Pot', 'العداد لا يتحمل جهد الاختبار العالي.', ARRAY['تحقق من سلامة كافة نقاط العزل.', 'تأكد من عدم وجود رطوبة داخل العداد.', 'اعتمد إجراء التجفيف ثم أعد الاختبار.', 'راجع مواصفات جهد الاختبار المعتمدة.']),
('RF-01', 'STG-03', 'فشل الاتصال اللاسلكي', 'العداد لا يتمكن من الاتصال بالشبكة اللاسلكية.', ARRAY['افحص لحام الهوائي على اللوحة.', 'قِس مستوى RSSI باستخدام أداة الاختبار المعتمدة.', 'تأكد من برمجة تردد الشبكة الصحيح.', 'استبدل وحدة الاتصال اللاسلكي إذا فشلت الحلول السابقة.']),
('RF-02', 'STG-03', 'ضعف شدة الإشارة (RSSI منخفض)', 'قوة الإشارة اللاسلكية أقل من الحد الأدنى.', ARRAY['تحقق من موضع الهوائي وزاويته.', 'افحص نقاط اللحام على مجمّع الهوائي.', 'جرّب نقل العداد لمنطقة أقوى إشارةً للاختبار.', 'راجع إعدادات قناة الإرسال.']),
('CAL-01', 'STG-04', 'خطأ معايرة الطاقة الفعّالة', 'انحراف في قراءة الطاقة الفعّالة عن القيمة المرجعية.', ARRAY['نظّف نقاط التلامس الكهربائية.', 'تأكد من ثبات مصدر الجهد المرجعي.', 'اضبط معامل التحويل في برنامج المعايرة.', 'أعد تشغيل عملية المعايرة من الصفر.']),
('CAL-02', 'STG-04', 'خطأ معايرة الطاقة التفاعلية', 'انحراف في قراءة الطاقة التفاعلية (KVAR).', ARRAY['تأكد من صحة اتصال دائرة القياس.', 'راجع معامل زاوية الطور (Phase Angle).', 'قارن مع معدات القياس المرجعية المعتمدة.']),
('MT-01', 'STG-05', 'فشل اختبار الذاكرة (Memory Test)', 'فشل في اختبار ذاكرة Flash أو RAM.', ARRAY['أعد تشغيل الاختبار مرة واحدة.', 'افحص سجل الأخطاء التقني (Log file).', 'تحقق من صحة برنامج العداد (Firmware version).', 'إذا تكرر الفشل، استبدل اللوحة الرئيسية.']),
('MT-02', 'STG-05', 'فشل اختبار الشاشة (Display Test)', 'أجزاء من الشاشة لا تعمل أو تعرض أرقاماً خاطئة.', ARRAY['افحص كابل توصيل الشاشة.', 'تأكد من ثبات الشاشة داخل الهيكل.', 'اختبر الشاشة بقيم مختلفة من البرنامج.', 'استبدل الشاشة إذا تأكد العطل.']),
('MT-03', 'STG-05', 'فشل اختبار منع التلاعب (Anti-Tamper)', 'لا يستجيب العداد لمستشعر التلاعب بشكل صحيح.', ARRAY['افحص موضع مستشعر المغناطيس.', 'تأكد من صحة أسلاك المستشعر.', 'راجع الإعدادات البرمجية لمنع التلاعب.']),
('PS-01', 'STG-06', 'خطأ في كتابة بيانات التخصيص', 'فشل كتابة بيانات العميل على ذاكرة العداد.', ARRAY['تأكد من صحة ملف التخصيص (Perso file).', 'تحقق من أن الذاكرة غير ممتلئة.', 'أعد محاولة الكتابة بعد تنظيف الذاكرة.', 'تحقق من حقوق الوصول للملف.']),
('PS-02', 'STG-06', 'خطأ في طباعة الملصق', 'الملصق النهائي لم يُطبع أو فيه بيانات غير صحيحة.', ARRAY['تحقق من اتصال الطابعة.', 'تأكد من صحة البيانات المرسلة للطابعة.', 'أعد تشغيل خدمة الطباعة.', 'استخدم ورق ملصقات جديد وتحقق من التوافق.']);
